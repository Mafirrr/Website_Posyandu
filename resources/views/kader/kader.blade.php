                        ...
                        <div class="card-body px-4 py-3">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="ms-auto">
                                    ...
                                    <a href="{{ route('kader.create') }}" id="btn-add-contact"
                                        class="btn btn-primary d-flex align-items-center">
                                        <i class="ti ti-plus text-white me-1 fs-5"></i> Tambah Kader
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card card-body border ">
                        <div class="row justify-content-between">
                            <div class="col-md-4 col-xl-4">
                                <form class="position-relative" method="GET" action="{{ route('kader.index') }}">
                                        ...
                                        @foreach ($anggotas as $key => $anggota)
                                            <tr class="border-b dark:border-gray-500">
                                                ...
                                                <td class="d-flex gap-2">
                                                    <a href="{{ route('kader.edit', $anggota->id) }}"
                                                    ...
                                                    <form id="form-delete-{{ $anggota->id }}"
                                                        action="{{ route('kader.destroy', $anggota->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="button"
