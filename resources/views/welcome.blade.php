...
<body class="text-gray-800 bg-white">
    <header x-data="{ open: false }" class="flex justify-between items-center px-6 py-4 shadow relative">
        ...
        <div x-show="open" @click.away="open = false"
            ...
            <a href="profile" class="text-base text-blue-900 hover:text-blue-600">Profil</a>
    ...
    <section id="beranda"
        class="px-12 py-16 flex flex-col md:flex-row items-center gap-12 bg-gradient-to-br from-white to-blue-50">
        <div class="flex-1 space-y-6">
            <h1 class="text-4xl md:text-5xl font-bold leading-tight">
                Posyandu digital, <span class="text-blue-600">solusi terpercaya</span><br />
                untuk kesehatan
            </h1>
            <p class="text-base">
                <span class="text-[#0084D4] font-semibold">Temani setiap langkah kehamilan anda.</span>
                <span class="text-black">
                    Layanan Posyandu digital siap bantu pantau kesehatan ibu dan janin, langsung dari rumah. Terhubung
                    dengan
        ...
        <div class="flex-1 relative">
            <img src="storage/images/1.png" alt="Dokter" class="rounded-lg">
        </div>
    </section>
    ...
    <section id="layanan" class="px-8 py-20 max-w-5xl mx-auto text-center">
        <h2 class="text-2xl text-center font-bold mb-6">
            Layanan <span class="text-blue-600">terbaik yang</span> kami tawarkan
        </h2>
    ...
    <section id="profile" class="bg-blue-50 px-8 py-16">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="grid gap-6">
                <div class="bg-white rounded-2xl shadow p-6 flex gap-4 items-center">
                    <img src="storage/images/2.png" alt="Kader" class="object-cover w-50 h-50">
                    <div>
                ...
                <div class="bg-white rounded-2xl shadow p-6 flex gap-4 items-center">
                    <img src="storage/images/2.png" alt="Bidan" class="object-cover w-50 h-50">
                    <div>
    ...
    <section id="profile" class="px-8 py-20 max-w-5xl mx-auto">
        <h2 class="text-2xl text-center font-bold mb-6">
            <span class="text-blue-600">Posyandu Tapen:</span> Kenali kami lebih dekat
        </h2>
        <div
            class="bg-white rounded-3xl shadow p-8 border border-[#95DDFF] flex flex-col md:flex-row items-center gap-8">
            <img src="storage/images/3.png" alt="Posyandu Tapen" class="w-50 h-50 object-cover">
            <div class="flex-2">
    ...
    <section class="bg-gradient-to-br from-white to-blue-50 px-8 py-20 text-center">
        <h2 class="text-2xl text-center font-bold mb-6">
            Cara <span class="text-blue-600">Kerja Platform</span> Kami
        </h2>
        ...
        <div class="max-w-6xl mx-auto flex flex-col md:flex-row items-start gap-12 text-left">
            ...
            <div class="flex-1 self-center">
                <img src="storage/images/4.png" alt="Ilustrasi Langkah-langkah" class="w-full max-w-sm md:ml-auto" />
            </div>
        </div>
    </section>

    <section id="tentang kami" class="px-8 py-20 bg-white">
    ...
    <footer id="kontak" class="text-gray-500 py-8 px-8" style="background-color: #F2FAFF;">
        <div class="max-w-6xl mx-auto grid md:grid-cols-3 gap-24">
            <div>
                <img src="storage/images/logo.png" alt="Logo Posyandu" class="w-24 mb-4">
